...
export default function VoicePage() {
  ...
  return (
    <>
      <Head>
        <title>สร้างเสียง AI - PD Studio</title>
        <meta name="description" content="สร้างเสียงพากย์คุณภาพสูงด้วย AI | PD Studio" />
      </Head>
      ...
      {/* Main App - Use ChatInterfaceGenerator with default mode = voice */}
      {status === 'authenticated' && (
        <ChatInterfaceGenerator defaultMode="voice" />
      )}
    </>
  )
}
