...
export default function VideoPage() {
  ...
  return (
    <>
      <Head>
        <title>สร้างวิดีโอ AI - PD Studio</title>
        <meta name="description" content="สร้างวิดีโอโฆษณาคุณภาพสูงด้วย AI | PD Studio" />
      </Head>
      ...
      {/* Main App - Use ChatInterfaceGenerator with default mode = video */}
      {status === 'authenticated' && (
        <ChatInterfaceGenerator defaultMode="video" />
      )}
    </>
  )
}
