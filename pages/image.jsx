...
export default function ImagePage() {
  ...
  return (
    <>
      <Head>
        <title>สร้างภาพ AI - PD Studio</title>
        <meta name="description" content="สร้างภาพโฆษณาคุณภาพสูงด้วย AI | PD Studio" />
      </Head>
      ...
      {/* Main App - Use ChatInterfaceGenerator with default mode = image */}
      {status === 'authenticated' && (
        <ChatInterfaceGenerator defaultMode="image" />
      )}
    </>
  )
}
