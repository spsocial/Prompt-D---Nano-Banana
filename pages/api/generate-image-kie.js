  ...
  try {
    ...
    const requestBody = {
      ...
      input: {
        prompt: prompt,
        output_format: 'png',
        image_size: aspectRatio // KIE.AI uses same format: 1:1, 16:9, 9:16, etc.
      }
    }
    ...
    res.status(200).json({
      ...
      model: modelName,
      mode: mode,
      message: `✨ Image ${mode === 'image-edit' ? 'edited' : 'generated'} successfully with KIE.AI Nano Banana!`,
    ...
    res.status(500).json({
      ...
      suggestion: '⚠️ เกิดข้อผิดพลาดในการสร้างภาพผ่าน KIE.AI'
    })
  }
}
