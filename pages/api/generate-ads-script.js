...
4. ต้องลงท้ายด้วย: "จิ้มที่ตระกร้าได้เลย${genderSuffix}"
5. ห้ามใช้คำยากหรือยาวเกินไป
6. ห้ามมีคำหยาบหรือไม่สุภาพ
7. ถ้ามี userInput ให้นำมาใช้ในบทพูดด้วย

ตัวอย่างรูปแบบ:
"${productName} {จุดเด่น} {ความพิเศษ} {คำกระตุ้น} จิ้มที่ตระกร้าได้เลย${genderSuffix}!"
...
ให้แค่บทพูดอย่างเดียว ไม่ต้องอธิบาย ไม่ต้องมีเครื่องหมายคำพูด`
    ...
    if (!script.includes('จิ้มที่ตระกร้า')) {
      script += ` จิ้มที่ตระกร้าได้เลย${genderSuffix}!`
    }
