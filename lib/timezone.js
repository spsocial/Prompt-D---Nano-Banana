 ...
 * For use with PostgreSQL DATE type - returns the Thailand date at UTC midnight
 * @returns {Date} Date object representing today's date in Thailand
 */
export function getThailandToday() {
  ...
  // For PostgreSQL DATE type, we need to send the Thailand date at 00:00 UTC
  // So Thailand Nov 26 should be stored as 2025-11-26T00:00:00Z
