            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0 z-10">
              ...
              <div className="relative" data-profile-menu>
                <button
                  ...
                  className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-[#00F2EA] to-[#FE2C55] p-0.5 hover:shadow-lg hover:shadow-[#00F2EA]/50 transition-all flex-shrink-0"
                >
                  {session?.user?.image ? (
                    <img
                ...
                {/* Profile Dropdown */}
                {showProfileMenu && (
                  <div className="absolute right-0 mt-2 w-48 sm:w-56 bg-[#1a1a1a] border border-gray-800 rounded-xl shadow-xl overflow-hidden z-50">
                    {/* User Info */}
                    <div className="px-3 sm:px-4 py-2 sm:py-3 border-b border-gray-800">
                      <p className="text-xs sm:text-sm font-semibold text-white truncate">{session?.user?.name}</p>
                    ...
                    <div className="py-1">
                      ...
                      <button
                        ...
                        className="w-full px-3 sm:px-4 py-2 text-xs sm:text-sm text-red-400 hover:bg-red-500/10 hover:text-red-300 flex items-center gap-2 transition-colors"
                      >
